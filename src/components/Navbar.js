        ...
        <header className="text-gray-400 bg-gray-900 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <Link to='/' className="mr-5 hover:text-white">All-Events</Link>
                    <Link to='/event/:id' className="mr-5 hover:text-white">Particular-Events</Link>
                    <Link to='/register/:id' className="mr-5 hover:text-white">Registeration</Link>
                    <Link to='/confirmation' className="mr-5 hover:text-white">Confirmation</Link>
                </nav>
